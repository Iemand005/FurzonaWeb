...
if (loginForm instanceof HTMLFormElement) {
  ...
  var forgotButton = document.getElementById("forgot-password-btn");
  if (forgotButton instanceof HTMLButtonElement) {
    forgotButton.onclick = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var formData, email, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            _context.p = 1;
            _context.n = 2;
            return furzona.forgotPassword(email.trim());
          case 2:
