...
function renderProfile(profile) {
  ...
  statsEl.innerHTML = [["Posts", stats.posts], ["Liked", stats.liked], ["Likes", stats.likes], ["Comments", stats.comments], ["Followers", stats.followers], ["Following", stats.followed]].map(([label, value]) => `
		<div class="stat">
...
;
if (id) {
  furzona.getProfile(id).then(profile => {
